...
"[project]/app/api/pdfs/finalize-upload/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Body = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    pdfId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1)
});
async function POST(req) {
    // ✅ Next 16: isAdmin is async
    ...
    const pdf = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].pdf.findUnique({
        where: {
    ...
    console.log("FINALIZE checking:", pdf.storageKey, "bucket:", process.env.S3_BUCKET);
    const head = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$s3$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["existsObject"])(pdf.storageKey);
    if (!head.ok) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].pdf.delete({
            where: {
                id: pdf.id
            }
        }).catch(()=>{});
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "S3 verify failed; DB row removed.",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2ac3cc21._.js.map