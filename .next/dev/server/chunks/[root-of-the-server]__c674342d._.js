...
"[project]/app/api/pdfs/[id]/delete/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(_req, { params }) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isAdmin"])()) {
    ...
    if (!pdf) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: "Not found"
    }, {
        status: 404
    });
    // Try deleting from S3; even if it fails, still delete DB row to clean library
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$s3$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteObject"])(pdf.storageKey).catch(()=>{});
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c674342d._.js.map